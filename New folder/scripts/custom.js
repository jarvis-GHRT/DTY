...
function showRefundPolicy() { 
    $('#HTMLModal_title').html('Refund Policy');
    $('#HTMLModal_konten').html('<center><img src="ui/ui/images/loading.gif"></center>');
    $('#HTMLModal').modal({
        'show': true,
        'backdrop': false,
    });
    $.get('pages/Refund_Policy.html?' + (new Date()), function(data) {
        $('#HTMLModal_konten').html(data);
    });
}

function showAboutUs() { 
    $('#HTMLModal_title').html('About Us');
    $('#HTMLModal_konten').html('<center><img src="ui/ui/images/loading.gif"></center>');
    $('#HTMLModal').modal({
        'show': true,
        'backdrop': false,
    });
    $.get('pages/About_Us.html?' + (new Date()), function(data) {
        $('#HTMLModal_konten').html(data);
    });
}